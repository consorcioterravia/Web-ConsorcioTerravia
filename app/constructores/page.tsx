...
export default function Constructores() {
  const data = [
    { id: 1, title: "Alianzas Estratégicas", description: "Buscamos socios con los más altos estándares constructivos.", img: "/property-3.jpg" },
    { id: 2, title: "Tecnología en Obra", description: "Implementación de BIM y seguimiento en tiempo real.", img: "/property-1.jpg" },
    { id: 3, title: "Materiales Sostenibles", description: "Compromiso con el medio ambiente y la durabilidad.", img: "/ecosystem-interior.jpg" },
  ];
    ...
    <div className="bg-surface-container-lowest min-h-screen flex flex-col" style={{ animation: 'fadeIn 0.8s ease-out' }}>
      ...
      <main className="flex-grow">
        <section className="py-20 px-margin-mobile md:px-margin-desktop max-w-screen-2xl mx-auto">
          <div className="mb-16">
            <h1 className="font-display-lg text-display-lg font-black tracking-tighter text-on-surface mb-4">Constructores</h1>
            <p className="font-body-lg text-on-surface-variant max-w-2xl">
              Únete a nuestra red de constructores certificados. Elevamos la calidad del mercado aplicando principios de Minimalismo Industrial y rigurosidad técnica.
            </p>
          </div>
