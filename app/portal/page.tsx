...
export default function Portal() {
  const data = [
    { id: 1, title: "Dashboard de Proyectos", description: "Visualiza el avance de tus obras en tiempo real con integración BIM.", img: "/property-1.jpg" },
    { id: 2, title: "Gestión Documental", description: "Acceso seguro a contratos, reportes y planos bajo tecnología avanzada.", img: "/property-2.jpg" },
    { id: 3, title: "Atención Especializada", description: "Soporte técnico y asesoría directa a través de nuestro ecosistema.", img: "/ecosystem-interior.jpg" },
  ];
    ...
    <div className="bg-surface-container-lowest min-h-screen flex flex-col" style={{ animation: 'fadeIn 0.8s ease-out' }}>
      ...
      <main className="flex-grow">
        <section className="py-20 px-margin-mobile md:px-margin-desktop max-w-screen-2xl mx-auto">
          <div className="mb-16">
            <h1 className="font-display-lg text-display-lg font-black tracking-tighter text-on-surface mb-4">Portal de Clientes</h1>
            <p className="font-body-lg text-on-surface-variant max-w-2xl">
              Tu entorno digital exclusivo. Accede a todas las herramientas Proptech de Terravía para gestionar, monitorear y optimizar tus inversiones inmobiliarias.
            </p>
          </div>
